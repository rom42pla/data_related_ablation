...
# from lightning.callbacks import EarlyStopping, StochasticWeightAveraging, ModelCheckpoint
...
#                     continue
#                 logs_fold = pd.read_csv(
#                     join(experiment_path, subject, fold, "logs.csv"))
